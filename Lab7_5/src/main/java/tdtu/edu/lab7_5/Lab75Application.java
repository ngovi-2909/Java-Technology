...
import tdtu.edu.lab7_5.service.StudentServiceImpl;
...
public class Lab75Application implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        this.showStudents();
        Collection<Student> studentList = this.studentService.findStudentsWithAgeGreaterThanEqual(19);
